...
<div class="reader">
    <div class="reader-inner g-box">
        ...
        <div class="metadata">
            ...
            <span class="date">
                September 6, 2021 by Marisa McClellan
            </span>

        </div>

        <div class="featured-image">
            <img src="https://foodinjars.com/wp-content/uploads/2023/09/fig-jam-jars-labeled-horizontal.jpg" alt="img" />
        </div>
